// src/main.js
/**
 * Main entry point for SmartCryptoFramework application
 */
...
class SmartCryptoFramework {
    /**
     * Create a new SmartCryptoFramework instance
...
module.exports = SmartCryptoFramework;
...
if (require.main === module) {
    ...
    const app = new SmartCryptoFramework({
        input: args.input,
        output: args.output,
